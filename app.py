...
def genera_pdf(assignment_id: int):
    ...
    def draw_photo_grid(photo_keys):
        ...
        # Connessione privata a Cloudflare R2
        r2_bucket = os.environ.get("R2_BUCKET")
        r2_endpoint = os.environ.get("R2_ENDPOINT")
        r2_access_key = os.environ.get("R2_ACCESS_KEY_ID")
        r2_secret_key = os.environ.get("R2_SECRET_ACCESS_KEY")
        ...
        for stage_key in photo_keys:
            ...
            try:
                ...
                # Recupera solamente il nome del file
                # sia dai vecchi URL R2 sia dai nuovi r2.dev
                object_key = photo_url.rstrip("/").rsplit("/", 1)[-1]
